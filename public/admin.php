...
<link rel="alternate" type="application/rss+xml" title="Realty &raquo; Feed" href="http://demo.themetrail.com/realty/feed/" />
<link rel="alternate" type="application/rss+xml" title="Realty &raquo; Comments Feed" href="http://demo.themetrail.com/realty/comments/feed/" />
...
<link rel="alternate" type="application/json+oembed" href="http://demo.themetrail.com/realty/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.themetrail.com%2Frealty%2Ffavorites%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://demo.themetrail.com/realty/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.themetrail.com%2Frealty%2Ffavorites%2F&#038;format=xml" />
...
<div class="textwidget"><a href="tel:7742131414">+1 774-213-1414</a><a href="mailto:info@311.dchr.host">info@311.dchr.host</a></div>
	...
	<a href="http://demo.themetrail.com/realty/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fdemo.themetrail.com%2Frealty%2F&amp;_wpnonce=14a4bee8b8">
...
<li id="menu-item-258" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-258"><a href="#">Properties</a>
<ul class="sub-menu">
	...
	<li id="menu-item-245" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-193 current_page_item menu-item-245"><a href="http://demo.themetrail.com/realty/favorites/">Favorite Properties</a></li>
...
<div class="property-item border-box">
	...
	<!--<footer class="site-footer" id="footer">
        ...
        <div class="container">
          <div class="row">
          <div class="col-sm-4"><ul class="list-unstyled"><li class="widget widget_text"><div class="widget-content"><h5 class="widget-title">Get started with Realty</h5>			<div class="textwidget"><p>Realty is a best-selling real estate theme with 5-star customer support and excellent and in-depth documentation. Join thousands of customers.</p>
<p><a href="http://themetrail.com/out/realty" class="btn btn-primary">Get the theme now &raquo;</a></p>
</div>
			  ...
			  "use strict";
	        	...
	        	.slick({
			        ...
			        nextArrow: '<i class="icon-arrow-right"></i>',
			        			        appendArrows: '#arrow-container-agent_carousel_1580322636',
			        			        			        			        responsive: [
			          {
			            breakpoint: 768,
			            settings: {
...
<li id="menu-item-1078" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1078"><a href="http://themeforest.net/item/realty-unique-real-estate-wordpress-theme/8583309/support">Get Support</a></li>
</ul></div></div>							</div>
											</div>
				</div>
			</div>
