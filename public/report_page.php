...
<link rel="alternate" type="application/rss+xml" title="Realty &raquo; Futuristic Nest Comments Feed" href="http://demo.themetrail.com/realty/property/futuristic-nest/feed/" />
<meta property="og:image" content="http://demo.themetrail.com/realty/wp-content/uploads/2015/10/realty-property-one-story-house-2.jpg" />		<script type="text/javascript">
...
<link rel='shortlink' href='http://demo.themetrail.com/realty/?p=142' />
<link rel="alternate" type="application/json+oembed" href="http://demo.themetrail.com/realty/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.themetrail.com%2Frealty%2Fproperty%2Ffuturistic-nest%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://demo.themetrail.com/realty/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.themetrail.com%2Frealty%2Fproperty%2Ffuturistic-nest%2F&#038;format=xml" />
			...
			(function($) {
			  "use strict";
	        	...
	        	.slick({
			        ...
			        prevArrow: '<i class="icon-arrow-left"></i>',
			        nextArrow: '<i class="icon-arrow-right"></i>',
			        			        appendArrows: '#arrow-container-agent_carousel_568013416',
			        			        			        			        responsive: [
			          {
			            breakpoint: 768,
			            settings: {
      ...
      <div class="modal-body">
		...
		<form name="loginform" id="loginform" action="http://demo.themetrail.com/realty/wp-login.php" method="post">
			...
			<p class="login-submit">
				...
				<input type="hidden" name="redirect_to" value="http://demo.themetrail.com/realty/property/futuristic-nest/" />
			</p>
			<a href="http://demo.themetrail.com/realty/wp-login.php?action=lostpassword&redirect_to=http%3A%2F%2Fdemo.themetrail.com%2Frealty%2Fproperty%2Ffuturistic-nest%2F">Lost Password?</a>
		</form>
				<script>
				(function($) {
				  "use strict";
